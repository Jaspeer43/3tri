<?php
    ...
    class Avaliador extends Usuario{
        ...
        public function __toString() {
            return  "[avaliador]<br>ID do avaliador: ".$this->getId()."<br>".
                    "Nome do avaliador: ".$this->getNome()."<br>".
                    "Sobrenome do avaliador: ".$this->getSobrenome()."<br>".
                    "Atuação: ".$this->getAtuacao()."<br>".
                    "Edição: ".$this->getEdicao()."<br>".
                    "Avaliador ou avaliador: ".$this->getAvor()."<br>".
                    "Email: ".$this->getEmail()."<br>".
                    "Senha: ".$this->getSenha()."<br>";
        }

        public function insere(){
            $sql = 'INSERT INTO fetec.avaliador (nome, sobrenome, atuacao, edicao_id, avor, email, senha) 
        ...
        public function excluir(){
            $sql = 'DELETE FROM fetec.avaliador WHERE id = :id';
        ...
        public static function listar($buscar = 0, $procurar = ""){
            ...
            $consulta = "SELECT * FROM edicao, avaliador WHERE avaliador.edicao_id = edicao.id AND edicao.campus_id = ".$_SESSION['id']."" ;
            if($buscar > 0)
                switch($buscar){
        ...
        public static function efetuarLogin($email, $senha){
            $sql = "SELECT id, nome, sobrenome, atuacao, edicao_id FROM avaliador WHERE email = :email AND senha = :senha";
            $parametros = array(
                ':email' => $email,
                ':senha' => $senha,
            );
