<?php
    ...
    class Avaliador extends Usuario{
        ...
        public function insere(){
            $sql = 'INSERT INTO fetec.avaliador (nome, sobrenome, atuacao, foto, email, senha, edicao_id, avor) 
        ...
        public static function efetuarLogin($email, $senha){
            $sql = "SELECT id, nome, sobrenome, atuacao, foto, edicao_id FROM avaliador WHERE email = :email AND senha = :senha";
            $parametros = array(
                ':email' => $email,
                ':senha' => $senha,
            );
